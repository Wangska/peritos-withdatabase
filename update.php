...
<body>
  ...
  <div class="container">
    ...
    <form method="POST" action="/conmod/update.php">
      ...
      <div class="quiz-section">
        ...
        <div class="quiz-item">
          ...
          <input type="text" id="technical_controls" name="technical_controls" value="<?php echo ($form_data['technical_controls'] ?? ''); ?>">
        ...
        <div class="quiz-item">
          <label>3. Which security measures help prevent malware infections?</label>
          <?php
          $options = [
          ...
          $selectedOptions = isset($form_data['q3']) ? explode(',', $form_data['q3']) : [];

          foreach ($options as $value => $label) {
            $checked = in_array($value, $selectedOptions) ? 'checked' : '';
        ...
        <div class="quiz-item">
          ...
          $selectedOptions = explode(',', $form_data['q7']);
          foreach ($options as $value => $label) {
            $checked = in_array($value, $selectedOptions) ? 'checked' : '';
        ...
        <div class="quiz-item">
          ...
          $selectedOptions = explode(',', $form_data['q13']);
          foreach ($options as $value => $label) {
            $checked = in_array($value, $selectedOptions) ? 'checked' : '';
